...
def main():
	datapath = '/content/drive/My Drive/Masterarbeit/topics_over_time/technology-data/'
	#'/Users/Mona/Google_Drive/Masterarbeit/topics_over_time/technology-data/' #'../../data/pnas/'
	resultspath = '/content/drive/My Drive/Masterarbeit/topics_over_time/results/'
	#'/Users/Mona/Google_Drive/Masterarbeit/topics_over_time/results/technology-tot/'
